...
public class Skyddsvart extends Geometry {
    public Skyddsvart(String name,String type,JSONObject featureRow) {
        ...
        System.out.println("Skyddsvärt träd är anropad");
        ...
        setFixedGID(associatedData.get("FixedGID").toString()); // Plockar ut UUID ur json-filen och lagrar tillgängligt som "Geometry". Observera att detta saknas i blockdata.
